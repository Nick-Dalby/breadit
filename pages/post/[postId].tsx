...
const PostPage = () => {
  ...
  // could do this server side, but for now this works
  ...
  return (
    <div className="mx-auto my-7 max-w-5xl">
      <Post post={post} />
      <div className="-mt-1 rounded-b-lg border border-t-0 border-gray-300 bg-white p-5 pl-16">
        <p className="text-sm">
          Comment as{' '}
      ...
      <div className='-my-5 rounded-b-lg border border-t-0 border-gray-300 bg-white py-5 px-10'>
        <hr className='py-2' />
