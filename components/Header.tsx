    ...
    <div className="sticky top-0 z-50 flex bg-white px-4 py-2 shadow-sm items-center h-14">
      <Link href="/">
        <div className="flex flex-shrink-0 cursor-pointer items-center space-x-2">
          ...
          <div className="relative hidden h-10 w-20 sm:inline-block">
            <Image
              src="/breadit.svg"
              alt="logo"
              fill
      ...
      <form className="hidden flex-1 items-center space-x-2 rounded-full border border-gray-200 bg-gray-100 px-3 py-1 sm:flex">
      ...
      <div className="ml-auto flex items-center sm:ml-5 lg:hidden">
